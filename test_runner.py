...
def run_evaluation(file_path: str = "eval_questions_v2.json", resume_from: str | None = None):
    ...
    ts = int(time.time())
    report_file = f"eval_report_{ts}.txt"
    json_file = resume_from or f"eval_result_{ts}.json"
...
if __name__ == "__main__":
    ...
    ap.add_argument("questions", nargs="?", default="eval_questions_v2.json",
                    help="題庫 JSON 路徑")
